...
### 2026-09-25 (later — privacy page, IntaSend callback, handover fixes; merged to `main` as `145a666` and live; verified: `/privacy` 200, in sitemap, webhook answers 400 on empty body / 405 on GET, and a forged "COMPLETE" call was ignored with no database change)
